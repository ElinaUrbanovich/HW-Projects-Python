...
class Monster(Character): 
    ...
    def fight(self, dice): 
        ...
        fighting = {1: "Monster has a great supper! om-nom-nom", 
...
class MazeMaster: 
    ...
    def make_doors(self, num_of_rooms):
        number_of_doors = num_of_rooms * random.randint(2, 3)
        doors = []
    ...
    def main(self):
        ...
        number_of_rooms = int(input("How many rooms should be in the maze?\n"))

        maze = self.built_maze(number_of_rooms)

        hero = Hero(random.randint(0, number_of_rooms))
        monster = Monster(random.randint(0, number_of_rooms))
